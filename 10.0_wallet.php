    ...
    <div id="left">
        ...
        <nav>
            <ul>
                ...
                <a href="#"><li ><i class='fa fa-cloud'></i>Dữ liệu và Sao lưu</li></a>
                <a href="10.0_wallet.php"><li id="left_second"><i class='fa fa-expeditedssl'></i>Bảo mật</li></a></li>
                <a href="#"><li><i class='fas fa-users'></i>Mọi người và chia sẻ</li></a>
                <a href="#"><li><i class='fas fa-money-check'></i>Thanh toán và đăng ký</li></a>
            </ul>
        </nav>
        <footer>
            <a href="">Điều Khoản</a>
