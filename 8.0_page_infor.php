...
<header>
    ...
    <div id="left">
        <nav>
            <ul>
                <a href="#"><li id="left_first"><i class='fab fa-wpforms'></i>Thông tin cá nhân</li></a>
    ...
    if (!$result) {
        ...
        echo'<h2>Thông tin cá nhân của bạn</h2>';
        ...
        <div id="info_user">
           ...
           <p>Email: <?php echo $row['email']?></p> <br>
            ...
            <div id="update"><a href="6.0_page_update_infor.php">Sửa thông tin</a></div>
        <?php 
            }
            }
    else{
        echo'Bạn chưa đăng nhập <br>' ; 
        echo "<a href='2.0_login.php'>Đăng nhập</a>";
    }
     ?>
        </section>
    </div>
